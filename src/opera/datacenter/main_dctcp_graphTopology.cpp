...
int main(int argc, char **argv) {
    ...
    */
    ...
    GraphTopology* top = new GraphTopology(queuesize, &logfile, &eventlist, ECN, topfile);
    ...
    if (input.is_open()){
        ...
        while(!input.eof()){
            ...
            TcpSrc* flowSrc = new DCTCPSrc(NULL, NULL, eventlist, top, flow_src, flow_dst, is_tdtcp);
    ...
    //UM->start(timeFromSec(0.00001090)); // print utilization every X milliseconds.
