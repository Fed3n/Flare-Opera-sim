...
#ifndef QT
#define QT
typedef enum {RANDOM, ECN, COMPOSITE, CTRL_PRIO, LOSSLESS, LOSSLESS_INPUT, LOSSLESS_INPUT_ECN, CREDIT, BOLT, HPCC} queue_type;
#endif
...
class UtilMonitor : public EventSource {
 public:
    ...
    UtilMonitor(FatTreeTopology* top, EventList &eventlist, map<uint64_t, TcpSrc*> flow_map);
